    ...
    <main class="mt-5">
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                ...
                <div class="col-12 text-center">
                    <form action="wmc.php" method="post">
                    ...
                    <div class="wmc_display" style="font-weight: bold">
                        ...
                        function display(array $day): string
                        {
                            for ($i = 0; $i < 7; $i++) {
                                $display = "";
                                for ($i = 0; $i < 24; $i++) {
                                    $display .= "<p class='wmc_show'>Time: " . $i . ":00, Temperature: " . $day[$i] . "°C</p>";
                                }
                            }
                            return $display;
                        }?>
                    ...
                    <p style="text-align: center;">This version works with integer arrays.
                        <a href="wmc_ass.php">Click here to visit the association arrays version</a>
                    </p>
                </div>
