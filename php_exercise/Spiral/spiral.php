                ...
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="#">Spiral<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center">
                    <h2 style="font-weight: bold">Spiral</h2>
                    <br>
                    ...
                    <div class="form">
                        <form action="#" method="post">
                            <label class="num_input">
                                <input name="num" type="number" value="2" min="2" max="15">
                            </label>
                            <label class="button">
